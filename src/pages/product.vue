<template>
  <Layout :pageIndex=2>
    ...
    <div class="line-three">
      <span style="font-weight: 700;">解决的痛点</span>
    ...
    <div class="line-four">
      <span style="font-weight: 700;"> 我们的优势</span>
      ...
      >
        <el-tab-pane name="cooperation">
          ...
          <div class="line-five-content">
            ...
            <g-image
              alt="Example image"
              src="../../static/product_page/cooperation_content.png"
              width="950"
              height="550"
              fit="fill"
            />
        ...
        <el-tab-pane name="development">
          ...
          <div class="line-five-content">
            ...
            <g-image
              alt="Example image"
              src="../../static/product_page/development_content.png"
              width="950"
              height="550"
              fit="fill"
            />
